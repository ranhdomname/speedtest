 const typingSpeedTestDiv = document.getElementById('typing-speed-test');
typingSpeedTestDiv.appendChild(typing_text);
typingSpeedTestDiv.appendChild(inputField);
typingSpeedTestDiv.appendChild(errorTag);
typingSpeedTestDiv.appendChild(timeTag);
typingSpeedTestDiv.appendChild(wpmTag);
typingSpeedTestDiv.appendChild(cpmTag);
typingSpeedTestDiv.appendChild(button);
...
const typing_text = document.querySelector('#typing-speed-test .text-of-typing p');
const inputField = document.querySelector('#typing-speed-test .container .input-field');
const errorTag = document.querySelector('#typing-speed-test .errors span');
const timeTag = document.querySelector('#typing-speed-test .time span');
const wpmTag = document.querySelector('#typing-speed-test .wpm span');
const cpmTag = document.querySelector('#typing-speed-test .cpm span');
const button = document.querySelector('#typing-speed-test button');
